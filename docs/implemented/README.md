...
│   └── langgraph-workflow.md   # 6条工作流 + 23节点
│
├── search/                       # 搜索系统层
...
├── academic_qa/                # 学术QA系统 (新增)
    └── academic-qa-system.md   # 多跳推理 + 引用溯源 + 幻觉检测
```
...
│  └─────────────┘  └─────────────┘  └─────────────┘  └─────────────────┘   │
│  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐  ┌─────────────────┐   │
│  │academic_qa/│  │problem_    │  │  security/  │  │    sdk/         │   │
│  │  学术QA    │  │  oriented/ │  │   安全模块   │  │    SDK层        │   │
│  └─────────────┘  └─────────────┘  └─────────────┘  └─────────────────┘   │
├─────────────────────────────────────────────────────────────────────────────┤
...
| 文档 | 位置 | 说明 |
|------|------|------|
| intent-router.md | unified/intent-router.md | 17 种意图识别，7步路由流程 |
...
| 文档 | 位置 | 说明 |
|------|------|------|
| langgraph-workflow.md | langgraph-workflow/langgraph-workflow.md | 6 条工作流路径，23 个节点，状态定义 |
...
| 文档 | 位置 | 说明 |
|------|------|------|
| academic-qa-system.md | academic_qa/academic-qa-system.md | 18个模块：多跳推理 + 引用溯源 + 幻觉检测 + CRAG + Self-RAG + RAGAs |
